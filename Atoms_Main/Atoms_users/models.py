...
class Nested_Table(models.Model):
    ...
    SearchableFields = ["Node_Id", "Property","Node_Left","Node_Right"]
...
class MachineCardsList(models.Model):  # datapoints for particular kpi
    ...
    mode = ArrayField(models.CharField(max_length=200, blank=True),blank=True, null=True, default=list)
    Conversion_Fun = ArrayField(models.CharField(max_length=255,blank=True), blank=True, null=True, default=list)
